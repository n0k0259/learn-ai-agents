...
<CardGrid>
	...
	<LinkCard title="1.2 Observation & Action Spaces, Tools" description="Widening what an agent sees and does, five kinds of tools, and how tool calling works." href="/learn-ai-agents/chapter-1/02-observation-action-tools/" />
	...
	<LinkCard title="1.7 Orchestration: Workflow vs. Autonomous" description="Single call, workflow, or autonomous agent — choosing, mixing, and stop conditions." href="/learn-ai-agents/chapter-1/07-orchestration-patterns/" />
